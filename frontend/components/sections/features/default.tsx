...
export default function FeaturesOverview() {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-transparent px-6 py-20 text-white">
      <div className="w-full max-w-[1200px] space-y-32">
        ...
        <div className="grid grid-cols-1 items-start gap-16 lg:grid-cols-[1fr_1.5fr] lg:gap-12">
          ...
          <div className="relative space-y-8">
            <div className="pointer-events-none absolute top-0 -left-32 h-64 w-64 rounded-full bg-[#FF7B2E]/5 blur-3xl" />
            <div className="relative space-y-6">
              <div>
                ...
                <BlurFade delay={0.75} inView>
                  <h1 className="text-3xl sm:text-5xl font-black tracking-tight text-zinc-50 fade-bottom uppercase">
